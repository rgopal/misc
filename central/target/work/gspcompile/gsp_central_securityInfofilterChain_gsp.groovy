...
class gsp_central_securityInfofilterChain_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/securityInfo/filterChain.gsp" }
public Object run() {
Writer out = getOut()
