...
printHtmlPart(13)
invokeTag('message','g',29,['code':("program.person.label"),'default':("Person")],-1)
printHtmlPart(14)
invokeTag('message','g',31,['code':("program.organization.label"),'default':("Organization")],-1)
printHtmlPart(15)
invokeTag('sortableColumn','g',33,['property':("credential"),'title':(message(code: 'program.credential.label', default: 'Credential'))],-1)
printHtmlPart(16)
invokeTag('sortableColumn','g',35,['property':("academicStratum"),'title':(message(code: 'program.academicStratum.label', default: 'Academic Stratum'))],-1)
printHtmlPart(16)
invokeTag('sortableColumn','g',37,['property':("academicMajor"),'title':(message(code: 'program.academicMajor.label', default: 'Academic Major'))],-1)
printHtmlPart(17)
loop:{
int i = 0
...
printHtmlPart(20)
expressionOut.print(fieldValue(bean: programInstance, field: "person"))
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1431724782948L
