...
class gsp_centralindex_gsp extends GroovyPage {
...
printHtmlPart(20)
if(true && (c.fullName ==~ /^central.*/)) {
printHtmlPart(21)
createTagBody(4, {->
printHtmlPart(22)
expressionOut.print(c.fullName.replace('central.','').replace('Controller',''))
})
invokeTag('link','g',122,['controller':(c.logicalPropertyName)],4)
printHtmlPart(23)
}
printHtmlPart(24)
}
...
public static final long LAST_MODIFIED = 1428184542109L
