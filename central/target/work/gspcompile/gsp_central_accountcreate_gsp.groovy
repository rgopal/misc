...
class gsp_central_accountcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(accountInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(accountInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:accountInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1425692208378L
