...
<html>
    ...
    <body>
        ...
        <div id="page-body" role="main">
            <h1>Welcome to Oumuo</h1>
            <p>Congratulations, you have successfully started your first Oumuo application! At the moment
            </p>

            <h1>Your online platform for personalized education!</h1>
